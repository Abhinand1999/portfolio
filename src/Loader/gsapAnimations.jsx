...
const gsapAnimations = () => {
    ...
    splitTextElements(".intro-title h3", "words, chars", true);
    splitTextElements(".outro-title h3");
    splitTextElements(".tag p", "words");
    splitTextElements(".cardss h3", "words, chars", true);
